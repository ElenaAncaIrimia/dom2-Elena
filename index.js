...
function add() {
  ...
  let productQuantity = document.querySelector(".product_quantity-input").value;
   ...
   // Verificar si el precio o la cantidad son menores o iguales a 0
   if (parseFloat(productPrice) <= 0 || parseFloat(productQuantity) <= 0) {
...
function editProduct(button) {
  ...
  let newPrice = parseFloat(prompt('Editar precio del producto:', productPrice));
  ...
  document.body.insertBefore(alertElement, document.querySelector('.productTable'));
